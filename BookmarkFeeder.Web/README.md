...
**Same-origin, always.** Requests go to a relative `/api/…`, which the YARP gateway routes to the API
— in dev and in production alike. There is no API base URL to configure, and no CORS.
