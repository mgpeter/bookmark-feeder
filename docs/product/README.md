...
- **Phase 5**: 🌐 Web Frontend Interface (PLANNED)
  - React application (Vite + shadcn/ui + TanStack Query), responsive design, management interface
...
- **Frontend**: React 19 (Vite), Tailwind CSS v4, shadcn/ui, TanStack Query, React Router
